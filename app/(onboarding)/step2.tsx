...
import { LifetimeIllustration } from '@/src/components/onboarding/OnboardingIllustrations';
...
export default function OnboardingStep2Screen() {
  ...
  return (
    <OnboardingScreen
      ...
      illustration={
        <LifetimeIllustration
          lifetimeLabel={t('onboarding.lifetimeBadge')}
          locationLabel={t('onboarding.publishedAtLocation')}
        />
      }
