...
export const ru: TranslationSchema = {
  ...
  onboarding: {
    ...
    languageDescription: 'Можно изменить позже в профиле.',
    step1Title: 'Только камера',
    step1Description:
      'В Hive нельзя загрузить фото из галереи — только снять здесь и сейчас. Так мы знаем, что снимок настоящий.',
    step2Title: '4 часа на карте',
    step2Description:
      'Каждое фото живёт 4 часа, потом исчезает. Карта показывает, что происходит рядом с вами прямо сейчас.',
    step3Title: 'Ульи',
    step3Description:
      'Если в одном месте много свежих фото, они собираются в улей — откройте его, чтобы посмотреть все снимки.',
