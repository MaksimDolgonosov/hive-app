...
export const en: TranslationSchema = {
  ...
  map: {
    ...
    emptyMessage: 'Take the first photo or check back later — moments live for 4 hours.',
  ...
  onboarding: {
    ...
    step1Description:
      'Every shot is taken on the spot — no gallery, no editing. So everything you see on the map is happening for real.',
